...
//   const lstHeThongRap = _.map(heThongRapChieu, heThongRap =>
...
//             </Grid>
//           </Box>
//           <Typography variant="caption">MOVIE BOOKING</Typography>
//         </Stack>
//       </Container>
//     </Box>
//   )
...
import { layThongTinRapAction } from 'src/redux/actions/QuanLyRapAction'
...
function Footer() {
  ...
  console.log('hethongrapchieu', cinemaList)
  const renderLogoParner = () => {
    return cinemaList?.map((Rap, index) => {
      return (
        <li className="mr-10 mb-2" key={index}>
          <img
  ...
  return (
    <footer className="py-6 text-white footer">
          ...
          <div className="pb-6 col-span-full md:pb-0 md:col-span-6">
            ...
            >
              <div className="flex items-center justify-center w-12 h-12 rounded-full text-white">
                <img
                  src="https://cdn-icons-png.flaticon.com/512/230/230994.png"
                  alt=""
                />
              </div>
        ...
        <div className="grid justify-center pt-6 lg:justify-between">
          ...
          <div className="flex justify-center pt-4 space-x-4 lg:pt-0 lg:col-end-13">
            <a
              ...
              href="/#"
              title="Email"
              className="flex items-center justify-center w-10 h-10 rounded-full  dark:text-coolGray-900"
            >
              <svg
